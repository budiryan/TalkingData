...
'''
Remove next click shift, tune lightgbm hyper parameter, remove tchan_count because NaNs,
also remove day from the predictors
'''
...
lgb_params = {
    ...
    'scale_pos_weight': 1000, # because training data is extremely unbalanced 
