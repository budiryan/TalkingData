...
train_df = do_countuniq( train_df, ['ip'], 'hour', 'X2', 'uint8', show_max=True ); gc.collect()
...
train_df = do_var( train_df, ['ip', 'channel'], 'hour', 'ip_tchan_count', show_max=True ); gc.collect()
...
predictors.extend(['app', 'channel', 'device', 'ip', 'is_attributed', 'os',
       'hour', 'X1', 'X7', 'X0', 'X2', 'X3', 'X4', 'X5', 'X6', 'X8',
