...
'''
Previous click feature included, much larger training set
remove feature shifting
'''
...
del(click_buffer)
QQ = np.log2(1 + np.array(prev_clicks))
...
print(train_df['nextClick'])
print(train_df['prevClick'])
